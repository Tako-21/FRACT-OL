...
void	print_help(void)
{
	...
	ft_putstr_fd("|                 \033[1;96mFRACT'OL\033[1;36m                |\n", 1);
	ft_putstr_fd("*-----------------------------------------*\033[0m\n", 1);
	...
	ft_putstr_fd("Usage example : \033[0;32m./fractol \033[0mJulia -0.7269 0.1889\n\n", 1);
	ft_putstr_fd("If no parameter is given to Julia, the program will run with\n", 1);
